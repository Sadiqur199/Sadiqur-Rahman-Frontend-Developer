...
const Search = () => {
  ...
  return (
    <div className="text-center">
      <h1 className="mt-16 uppercase font-bold text-xl">Search The Capsules</h1>
          ...
          <div className="">
            ...
            >
              ...
              {capsules.map((capsule) => (
                <option key={capsule.capsule_serial} value={capsule.capsule_serial}>
      ...
      <div className="mt-8 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        {searchResults.map((capsule) => (
          <div key={capsule.capsule_serial} className="card md:ml-[600px] sm:ml-[170px] w-96 p-16 bg-[#E4F3FF] shadow-xl  mx-auto">
            <p className="font-semibold">Serial Number: {capsule.capsule_serial}</p>
